...
local hex = {
    ...
    "#BF5650", "#E83000", "#66796D", "#DA007C", "#FF1A59", "#8844FF", "#1E0200", "#5B4E51",
...
for i, v in ipairs(hex) do
    local r = tonumber(string.sub(v, 2, 3), 16) / 255
    local g = tonumber(string.sub(v, 4, 5), 16) / 255
    local b = tonumber(string.sub(v, 6, 7), 16) / 255
    local c = {r, g, b}
